...
public class Settings extends SharedYouTubeSettings {
    ...
    // Flyout menu
    public static final BooleanSetting HIDE_FLYOUT_MENU_ADD_TO_LISTEN_LATER = new BooleanSetting("morphe_music_hide_flyout_menu_add_to_listen_later", FALSE, true);
    public static final BooleanSetting HIDE_FLYOUT_MENU_ADD_TO_QUEUE = new BooleanSetting("morphe_music_hide_flyout_menu_add_to_queue", FALSE, true);
    public static final BooleanSetting HIDE_FLYOUT_MENU_CAPTIONS = new BooleanSetting("morphe_music_hide_flyout_menu_captions", FALSE, true);
    public static final BooleanSetting HIDE_FLYOUT_MENU_DELETE_PLAYLIST = new BooleanSetting("morphe_music_hide_flyout_menu_delete_playlist", FALSE, true);
    public static final BooleanSetting HIDE_FLYOUT_MENU_DISMISS_QUEUE = new BooleanSetting("morphe_music_hide_flyout_menu_dismiss_queue", FALSE, true);
    public static final BooleanSetting HIDE_FLYOUT_MENU_DONT_RECOMMEND_ARTIST = new BooleanSetting("morphe_music_hide_flyout_menu_dont_recommend_artist", FALSE, true);
    public static final BooleanSetting HIDE_FLYOUT_MENU_DOWNLOAD = new BooleanSetting("morphe_music_hide_flyout_menu_download", FALSE, true);
    public static final BooleanSetting HIDE_FLYOUT_MENU_EDIT_PLAYLIST = new BooleanSetting("morphe_music_hide_flyout_menu_edit_playlist", FALSE, true);
    public static final BooleanSetting HIDE_FLYOUT_MENU_GO_TO_ALBUM = new BooleanSetting("morphe_music_hide_flyout_menu_go_to_album", FALSE, true);
    public static final BooleanSetting HIDE_FLYOUT_MENU_GO_TO_ARTIST = new BooleanSetting("morphe_music_hide_flyout_menu_go_to_artist", FALSE, true);
    public static final BooleanSetting HIDE_FLYOUT_MENU_GO_TO_EPISODE = new BooleanSetting("morphe_music_hide_flyout_menu_go_to_episode", FALSE, true);
    public static final BooleanSetting HIDE_FLYOUT_MENU_GO_TO_PODCAST = new BooleanSetting("morphe_music_hide_flyout_menu_go_to_podcast", FALSE, true);
    public static final BooleanSetting HIDE_FLYOUT_MENU_HELP = new BooleanSetting("morphe_music_hide_flyout_menu_help", FALSE, true);
    public static final BooleanSetting HIDE_FLYOUT_MENU_MARK_EPISODE_AS_PLAYED = new BooleanSetting("morphe_music_hide_flyout_menu_mark_episode_as_played", FALSE, true);
    public static final BooleanSetting HIDE_FLYOUT_MENU_NOT_INTERESTED = new BooleanSetting("morphe_music_hide_flyout_menu_not_interested", FALSE, true);
    public static final BooleanSetting HIDE_FLYOUT_MENU_PIN_TO_SPEED_DIAL = new BooleanSetting("morphe_music_hide_flyout_menu_pin_to_speed_dial", FALSE, true);
    public static final BooleanSetting HIDE_FLYOUT_MENU_PLAY_NEXT = new BooleanSetting("morphe_music_hide_flyout_menu_play_next", FALSE, true);
    public static final BooleanSetting HIDE_FLYOUT_MENU_QUALITY = new BooleanSetting("morphe_music_hide_flyout_menu_quality", FALSE, true);
    public static final BooleanSetting HIDE_FLYOUT_MENU_REMOVE_FROM_LIBRARY = new BooleanSetting("morphe_music_hide_flyout_menu_remove_from_library", FALSE, true);
    public static final BooleanSetting HIDE_FLYOUT_MENU_REMOVE_FROM_PLAYLIST = new BooleanSetting("morphe_music_hide_flyout_menu_remove_from_playlist", FALSE, true);
    public static final BooleanSetting HIDE_FLYOUT_MENU_REPORT = new BooleanSetting("morphe_music_hide_flyout_menu_report", FALSE, true);
    public static final BooleanSetting HIDE_FLYOUT_MENU_SAVE_EPISODE_FOR_LATER_SAVE_TO_LIBRARY = new BooleanSetting("morphe_music_hide_flyout_menu_save_episode_for_later_save_to_library", FALSE, true);
    public static final BooleanSetting HIDE_FLYOUT_MENU_SAVE_TO_PLAYLIST = new BooleanSetting("morphe_music_hide_flyout_menu_save_to_playlist", FALSE, true);
    public static final BooleanSetting HIDE_FLYOUT_MENU_SHARE = new BooleanSetting("morphe_music_hide_flyout_menu_share", FALSE, true);
    public static final BooleanSetting HIDE_FLYOUT_MENU_SHUFFLE_PLAY = new BooleanSetting("morphe_music_hide_flyout_menu_shuffle_play", FALSE, true);
    public static final BooleanSetting HIDE_FLYOUT_MENU_SLEEP_TIMER = new BooleanSetting("morphe_music_hide_flyout_menu_sleep_timer", FALSE, true);
    public static final BooleanSetting HIDE_FLYOUT_MENU_START_RADIO = new BooleanSetting("morphe_music_hide_flyout_menu_start_radio", FALSE, true);
    public static final BooleanSetting HIDE_FLYOUT_MENU_STATS_FOR_NERDS = new BooleanSetting("morphe_music_hide_flyout_menu_stats_for_nerds", FALSE, true);
    public static final BooleanSetting HIDE_FLYOUT_MENU_SUBSCRIBE = new BooleanSetting("morphe_music_hide_flyout_menu_subscribe", FALSE, true);
    public static final BooleanSetting HIDE_FLYOUT_MENU_UNPIN_FROM_SPEED_DIAL = new BooleanSetting("morphe_music_hide_flyout_menu_unpin_from_speed_dial", FALSE, true);
    public static final BooleanSetting HIDE_FLYOUT_MENU_VIEW_SONG_CREDIT = new BooleanSetting("morphe_music_hide_flyout_menu_view_song_credit", FALSE, true);
